public class Tome extends Weapon{
  ...
  private String type; /* types for tomes will be different kinds of spells. I will likely be implementing more conditions to go with these spells
  ...
  public Tome(int durability, int power, int weight, String type){
    super(durability, power, weight, 2, type, "Tome");
    this.type = type;
  }
